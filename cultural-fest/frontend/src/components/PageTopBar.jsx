        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="inline-flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={onBack}
              className="inline-flex items-center gap-2 rounded-full bg-[rgba(255,255,255,0.04)] px-3 py-1.5 text-xs font-medium uppercase tracking-[0.08em] text-[#EEE6D8]/82 transition hover:bg-[rgba(255,255,255,0.07)] hover:text-[#EEE6D8]"
              aria-label={backLabel}
            >
              <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-[rgba(190,163,93,0.12)] text-[13px] leading-none text-[#BEA35D]">
